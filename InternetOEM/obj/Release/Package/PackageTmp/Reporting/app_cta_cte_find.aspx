    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="blq_search col-3">
          ...
          <div>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="rdTxtDeudor" ForeColor="Red" ErrorMessage="* Debe seleccionar el deudor." ValidationGroup="ValidPage"></asp:RequiredFieldValidator>
          </div>
      ...
      <div class="row">
        <div class="col-3 text-left">
          <asp:Button ID="idBuscar" runat="server" Text="Buscar" CssClass="btn btn-primary btn-sm" OnClick="idBuscar_Click" ValidationGroup="ValidPage" />
        </div>
      </div>
      <div class="row">
        <div class="col-12">
