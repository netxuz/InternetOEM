...
{
  public partial class app_contactos_deudor_find : System.Web.UI.Page
  {
    ...
    protected void idBuscar_Click(object sender, EventArgs e)
    {
      ...
      rdGridContactosDeudor.Rebind();
    }

    protected void rdGridContactosDeudor_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
    {
      rdGridContactosDeudor.DataSource = getDatatble();
    }

    protected void rdGridContactosDeudor_ItemCommand(object source, GridCommandEventArgs e)
    {
      if (e.CommandName == RadGrid.ExportToExcelCommandName)
      {
        ...
        wb.Worksheets.Add(dt, "contactosdeudor");

        Response.Clear();
        Response.Buffer = true;
        Response.Charset = "";
        Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        Response.AddHeader("content-disposition", "attachment;filename=contactosdeudor_" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx");
