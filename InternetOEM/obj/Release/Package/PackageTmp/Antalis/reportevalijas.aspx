<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportevalijas.aspx.cs" Inherits="ICommunity.Antalis.reportevalijas" %>
      ...
      <div class="row vAlign">
        ...
        <div class="col-md-3">
          ...
          <asp:DropDownList ID="cmb_documento" CssClass="form-control" runat="server">
            ...
            <asp:ListItem Text="Transferencias" Value="6"></asp:ListItem>
          </asp:DropDownList>
        </div>
      </div>
      <div class="row vAlign">
      ...
      <div class="row">
        <div class="container">
          <asp:GridView ID="gdPagos" runat="server" CssClass="table table-hover"
            DataKeyNames="cod_pago, cod_tipo_pago" BorderStyle="Solid" AllowPaging="true"
            BorderWidth="0" GridLines="Horizontal"
            AutoGenerateColumns="false"
            OnSelectedIndexChanging="gdPagos_SelectedIndexChanging"
            OnPageIndexChanging="gdPagos_PageIndexChanging" PageSize="20"
