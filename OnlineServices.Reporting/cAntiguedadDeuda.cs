    ...
    public DataTable Get()
    {
      ...
      if (oConn.bIsOpen)
      {
        ...
        if ((!string.IsNullOrEmpty(pEstado)) && (pEstado == "0"))
        {
          ...
          cSQL.Append(" isnull((select sum(web.nSaldo) from AntiguedadDeudaWeb web where Web.nkey_cliente =").Append(lngCodNkey);
          ...
          if ((!string.IsNullOrEmpty(sTipoUsuario)) && (sTipoUsuario == "V"))
            cSQL.Append("  and web.nkey_deudor  in (select nkey_deudor from codigodeudor where nkey_cliente = ").Append(lngCodNkey).Append(" and nkey_vendedor = ").Append(lngNkeyUsuario).Append(") ");
          ...
          cSQL.Append(" where AntiguedadDeudaWeb.nkey_cliente = ").Append(lngCodNkey);
        ...
        else if ((!string.IsNullOrEmpty(pEstado)) && (pEstado == "1"))
        {
          ...
          cSQL.Append(" isnull((select sum(web.nSaldo) from AntiguedadDeudaWeb web where Web.nkey_cliente = ").Append(lngCodNkey).Append("  and web.nkey_deudor = AntiguedadDeudaWeb.nKEy_Deudor and web.natraso = '0'),0) as 'total_0', ");
          cSQL.Append(" isnull((select sum(web.nSaldo) from AntiguedadDeudaWeb web where Web.nkey_cliente = ").Append(lngCodNkey).Append("  and web.nkey_deudor = AntiguedadDeudaWeb.nKEy_Deudor and web.natraso = '15'),0) as 'total_15', ");
          cSQL.Append(" isnull((select sum(web.nSaldo) from AntiguedadDeudaWeb web where Web.nkey_cliente = ").Append(lngCodNkey).Append("  and web.nkey_deudor = AntiguedadDeudaWeb.nKEy_Deudor and web.natraso = '30'),0) as 'total_30', ");
          cSQL.Append(" isnull((select sum(web.nSaldo) from AntiguedadDeudaWeb web where Web.nkey_cliente = ").Append(lngCodNkey).Append("  and web.nkey_deudor = AntiguedadDeudaWeb.nKEy_Deudor and web.natraso = '60'),0) as 'total_60', ");
          cSQL.Append(" isnull((select sum(web.nSaldo) from AntiguedadDeudaWeb web where Web.nkey_cliente = ").Append(lngCodNkey).Append("  and web.nkey_deudor = AntiguedadDeudaWeb.nKEy_Deudor and web.natraso = '90'),0) as 'total_90', ");
          cSQL.Append(" isnull((select sum(web.nSaldo) from AntiguedadDeudaWeb web where Web.nkey_cliente = ").Append(lngCodNkey).Append("  and web.nkey_deudor = AntiguedadDeudaWeb.nKEy_Deudor and web.natraso = '180'),0) as 'total_180', ");
          cSQL.Append(" isnull((select sum(web.nSaldo) from AntiguedadDeudaWeb web where Web.nkey_cliente = ").Append(lngCodNkey).Append("  and web.nkey_deudor = AntiguedadDeudaWeb.nKEy_Deudor and web.natraso = '360'),0) as 'total_360' ");
          cSQL.Append(" from AntiguedadDeudaWeb join codigodeudor on (codigodeudor.nkey_cliente = AntiguedadDeudaWeb.nkey_cliente and codigodeudor.nkey_deudor = AntiguedadDeudaWeb.nkey_deudor) ");
          ...
          cSQL.Append(" join deudor on (deudor.nkey_deudor = codigodeudor.nkey_deudor) where AntiguedadDeudaWeb.nkey_cliente =").Append(lngCodNkey);
        ...
        else if ((!string.IsNullOrEmpty(pEstado)) && (pEstado == "2"))
        {
          ...
          cSQL.Append(" and servicio.nkey_analista = ").Append(lngCodDeudor).Append(" ) join deudor on (deudor.nkey_deudor = codigodeudor.nkey_deudor) where AntiguedadDeudaWeb.nkey_cliente =").Append(lngCodNkey);
          cSQL.Append(" group by CodigoDeudor.ncodigodeudor, deudor.snombre,AntiguedadDeudaWeb.nkey_deudor ");
          cSQL.Append(" Order by sum(AntiguedadDeudaWeb.nSaldo) desc ");
