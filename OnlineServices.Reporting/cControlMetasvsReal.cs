    ...
    public DataTable Get()
    {
      ...
      if (oConn.bIsOpen)
      {
        ...
        if (pEstado == "0")
        {
          ...
          cSQL.Append(" where Vista_MetasAnalistaCli.nkey_cliente = ").Append(lngCodNkey);
          ...
          if ((!string.IsNullOrEmpty(sTipoUsuario)) && (sTipoUsuario == "V"))
            cSQL.Append("  and Vista_MetasAnalistaCli.nkey_deudor in (select codigodeudor.nkey_deudor from codigodeudor where codigodeudor.nkey_vendedor = ").Append(lngNkeyUsuario).Append(" and codigodeudor.nkey_cliente = ").Append(lngCodNkey).Append(" )  ");
        ...
        else if (pEstado == "1")
        {
          ...
          cSQL.Append(" AND Servicio.nKey_Cliente = ").Append(lngCodNkey).Append(" and servicio.nkey_analista = ").Append(lngCodDeudor).Append(") ");
          ...
          cSQL.Append(" on (metasanalistadeudor.nkey_cliente =").Append(lngCodNkey);
          ...
          cSQL.Append(" AND Servicio.nKey_Cliente = ").Append(lngCodNkey).Append(" and servicio.nkey_analista != 4) ");
          cSQL.Append(" where codigodeudor.nkey_cliente =").Append(lngCodNkey);
          ...
          cSQL.Append(" on (metas.nkey_cliente =").Append(lngCodNkey);
