...
{
  public partial class app_cntrl_sol_not_crtd_find : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (!IsPostBack)
      {
        ...
        oLog.ObsLog = "REPORTE DE CONTROL DE SOLICITUD DE NOTAS DE CRÉDITO";
        oLog.CodEvtLog = "1";
    ...
    protected void idBuscar_Click(object sender, EventArgs e)
    {
      ...
      rdGridCntrSolNotaCredito.Rebind();
    }

    protected void rdGridCntrSolNotaCredito_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
    {
      rdGridCntrSolNotaCredito.DataSource = getDatatble();
    }

    protected void rdGridCntrSolNotaCredito_ItemCommand(object source, GridCommandEventArgs e)
    {
      if (e.CommandName == RadGrid.ExportToExcelCommandName)
      {
        ...
        wb.Worksheets.Add(dt, "controlsolicitudnotascredito");

        Response.Clear();
        Response.Buffer = true;
        Response.Charset = "";
        Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        Response.AddHeader("content-disposition", "attachment;filename=controlsolicitudnotascredito_" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx");
    ...
    public DataTable getDatatble()
    {
      ...
      if (oConn.Open())
      {
        ...
        oControlSolicitudNotasCredito.DtFchIni = DateTime.Parse(RadDatePicker1.SelectedDate.ToString()).ToString("yyyyMMdd");
        oControlSolicitudNotasCredito.DtFchFin = DateTime.Parse(RadDatePicker2.SelectedDate.ToString()).ToString("yyyyMMdd");
        dt = oControlSolicitudNotasCredito.Get();
