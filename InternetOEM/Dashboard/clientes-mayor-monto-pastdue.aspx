<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="clientes-mayor-monto-pastdue.aspx.cs" Inherits="ICommunity.clientes_mayor_monto_pastdue" %>
        ...
        <div class="container-fluid margin-conteiner">
          <div class="row">
            <div id="ClientesDeCuidado" runat="server" class="col-md-12">
              <div class="blq-tt">
                <span class="sub-tt-menu">CLIENTES CON MAYOR % EN MONTO PAST DUE</span><hr />
              </div>
