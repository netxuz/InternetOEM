    ...
    <div class="container">
      ...
      <div class="row">
        <telerik:RadGrid ID="rdTemplate" runat="server" ShowStatusBar="True" AutoGenerateColumns="false"
          ...
          OnItemCommand="rdTemplate_ItemCommand" OnItemDataBound="rdTemplate_ItemDataBound" Skin="Sitefinity">
          <MasterTableView DataKeyNames="cod_template" AutoGenerateColumns="false" ShowHeader="true"
