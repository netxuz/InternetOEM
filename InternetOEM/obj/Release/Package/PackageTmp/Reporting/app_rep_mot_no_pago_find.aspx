<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="app_rep_mot_no_pago_find.aspx.cs" Inherits="ICommunity.Reporting.app_rep_mot_no_pago_find" %>
...
<body>
  <form id="form1" runat="server">
    ...
    <div class="container-fluid">
      <div class="blq_tile">
        <asp:Label ID="lblTitle" runat="server" CssClass="lblTitle" Text="REPORTE MOTIVOS NO PAGO"></asp:Label>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-3 text-left">
          <asp:Button ID="idBuscar" runat="server" Text="Buscar" CssClass="btn btn-primary btn-sm" Width="100px" OnClick="idBuscar_Click" />
        </div>
      </div>
        ...
        <div class="col-12">
          ...
          <telerik:RadGrid ID="rdGridRepMotNoPago" runat="server" OnNeedDataSource="rdGridRepMotNoPago_NeedDataSource" OnItemCommand="rdGridRepMotNoPago_ItemCommand" OnItemDataBound="rdGridRepMotNoPago_ItemDataBound"
            ...
            <MasterTableView AutoGenerateColumns="false" ShowHeader="true" ShowFooter="true"
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="smotivonopago" HeaderText="Motivo"
                  UniqueName="smotivonopago">
