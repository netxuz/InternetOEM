...
{
  public partial class asignacion_centrodistribucion : System.Web.UI.Page
  {
    Web oWeb = new Web();
    ...
    protected void rdUsuarios_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
      switch (e.CommandName)
      {
        case "cmdEdit":
          ...
          Response.Redirect(String.Format("usuarios_centrosdistribucion.aspx?CodUsuario={0}", cParam));
          break;
      }
    }
