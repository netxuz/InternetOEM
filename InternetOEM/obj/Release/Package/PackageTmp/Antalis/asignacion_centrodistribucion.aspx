<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="asignacion_centrodistribucion.aspx.cs" Inherits="ICommunity.Antalis.asignacion_centrodistribucion" %>
...
<body class="bodyadm">
  <form id="form1" runat="server">
    ...
    <div class="container">
      <div class="row">&nbsp;</div>
      <div class="row">
        <h4>ASIGNACIÓN DE CENTROS DE DISTRIBUCION</h4>
      </div>
      <div class="row">
        <div class="col-xs-4">
      ...
      <div class="row">
        <telerik:RadGrid ID="rdUsuarios" runat="server" ShowStatusBar="True" AutoGenerateColumns="false"
          AllowSorting="True" PageSize="15" AllowPaging="True" GridLines="None" Skin="Sitefinity" OnNeedDataSource="rdUsuarios_NeedDataSource" OnItemCommand ="rdUsuarios_ItemCommand" OnItemDataBound="rdUsuarios_ItemDataBound" >
          <MasterTableView DataKeyNames="cod_user" AutoGenerateColumns="false" ShowHeader="true"
            ...
            <Columns>
              ...
              <telerik:GridBoundColumn UniqueName="EstUsuario" DataField="est_user" AllowSorting="true">
                <HeaderStyle Font-Size="Smaller" HorizontalAlign="Center" />
                <ItemStyle HorizontalAlign="Center" />
              </telerik:GridBoundColumn>
            </Columns>
