...
{
  public partial class app_cta_cte_find : System.Web.UI.Page
  {
    ...
    protected void rdGridCtaCte_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
    {
      rdGridCtaCte.DataSource = getDatatble();
    }

    protected void rdGridCtaCte_ItemCommand(object source, GridCommandEventArgs e)
    {
      if (e.CommandName == RadGrid.ExportToExcelCommandName)
      {
        ...
        wb.Worksheets.Add(dt, "cuentacorriente");

        Response.Clear();
        Response.Buffer = true;
        Response.Charset = "";
        Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        Response.AddHeader("content-disposition", "attachment;filename=cuentacorriente_" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx");
    ...
    protected void rdGridCtaCte_ItemDataBound(object sender, GridItemEventArgs e)
    {
    ...
    public DataTable getDatatble()
    {
      ...
      if (oConn.Open())
      {
        cCuentaCorriente oCuentaCorriente = new cCuentaCorriente(ref oConn);
        oCuentaCorriente.CodDeudor = hddCodDeudor.Value;
        oCuentaCorriente.CodNkey = oIsUsuario.CodNkey;
        oCuentaCorriente.NkeyUsuario = oIsUsuario.NKeyUsuario;
        oCuentaCorriente.TipoUsuario = oIsUsuario.TipoUsuario;
        oCuentaCorriente.Estado = Estado.SelectedValue;
        dt = oCuentaCorriente.Get();
