    ...
    public DataTable Get()
    {
      ...
      if (oConn.bIsOpen)
      {
        ...
        if (pEstado == "0")
        {
          ...
          cSQL.Append(" From tablacomportamientopagoweb JOIN cliente ON (tablacomportamientopagoweb.nkey_cliente = cliente.nkey_cliente) where tablacomportamientopagoweb.nkey_cliente in(").Append(lngCodNkey).Append(") ");
          ...
          if ((!string.IsNullOrEmpty(sTipoUsuario)) && (sTipoUsuario == "V"))
            cSQL.Append("  and tablacomportamientopagoweb.nkey_deudor  in (select nkey_deudor from codigodeudor where nkey_cliente in(").Append(lngCodNkey).Append(") and nkey_vendedor = ").Append(lngNkeyUsuario).Append(") ");
        ...
        else if (pEstado == "2")
        {
          ...
          cSQL.Append(" and servicio.nkey_analista = ").Append(lngCodAnalista).Append(" ) where tablacomportamientopagoweb.nkey_deudor = ").Append(lngCodDeudor).Append(" and tablacomportamientopagoweb.nkey_cliente in (").Append(lngCodNkey).Append(") ");
        ...
        else if (pEstado == "3")
        {
          ...
          cSQL.Append(" where tablacomportamientopagoweb.nkey_deudor = ").Append(lngCodDeudor).Append(" and tablacomportamientopagoweb.nkey_cliente in(").Append(lngCodNkey).Append(") group by Deudor.snombre , tablacomportamientopagoweb.periodo, tablacomportamientopagoweb.orden, ");
        ...
        else if (pEstado == "4")
        {
          ...
          cSQL.Append(" tablacomportamientopagoweb.mesano1 as 'MesAno1', tablacomportamientopagoweb.mesano2 as 'MesAno2', tablacomportamientopagoweb.mesano3 as 'MesAno3', tablacomportamientopagoweb.mesano4 as 'MesAno4', tablacomportamientopagoweb.mesano5 as 'MesAno5', ");
          cSQL.Append(" tablacomportamientopagoweb.mesano6 as 'MesAno6', tablacomportamientopagoweb.mesano7 as 'MesAno7', tablacomportamientopagoweb.mesano8 as 'MesAno8', tablacomportamientopagoweb.mesano9 as 'MesAno9', tablacomportamientopagoweb.mesfila  as 'Mesfila' ");
          cSQL.Append(" From tablacomportamientopagoweb JOIN cliente ON (tablacomportamientopagoweb.nkey_cliente = cliente.nkey_cliente) where cliente.ncodholding = ").Append(pNcodHolding);
