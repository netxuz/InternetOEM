  ...
  public partial class app_cop_ced_bod_bus : System.Web.UI.Page
  {
    ...
    public DataTable getDatatble()
    {
      ...
      if (oConn.Open())
      {
        ...
        oCopiaCedibleDebtControl.CodNkey = ((!string.IsNullOrEmpty(cmbCliente.SelectedValue) ? cmbCliente.SelectedValue : hdd_arrNkeyCliente.Value));
    ...
    protected void rdGridCopCedibleDebt_ItemDataBound(object sender, GridItemEventArgs e)
    {
