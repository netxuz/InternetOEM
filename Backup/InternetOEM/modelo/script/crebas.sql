...
/*   Index: nom_user                                            */
/* ============================================================ */
create index nom_user on sys_usuario (nom_usuario)
go

/* ============================================================ */
/*   Index: ape_user                                            */
/* ============================================================ */
create index ape_user on sys_usuario (ape_usuario)
go

/* ============================================================ */
/*   Index: eml_user                                            */
/* ============================================================ */
create index eml_user on sys_usuario (eml_usuario)
go

/* ============================================================ */
/*   Index: login_user                                          */
/* ============================================================ */
create index login_user on sys_usuario (login_usuario)
go
...
/*   Index: cod_usuario                                         */
/* ============================================================ */
create index cod_usuario on cms_nodos (cod_usuario)
go
...
/*   Index: cod_usuario                                         */
/* ============================================================ */
create index cod_usuario on cms_contenidos (cod_usuario)
go
...
/*   Index: cod_usuario                                         */
/* ============================================================ */
create index cod_usuario on syr_info_usuarios (cod_usuario)
go
...
/*   Index: cod_usuario                                         */
/* ============================================================ */
create index cod_usuario on cmr_nodos_usuarios (cod_usuario)
go
...
/*   Index: cod_grupo                                           */
/* ============================================================ */
create index cod_grupo on cmr_nodos_grupos (cod_grupo)
go
...
/*   Index: cod_usuario                                         */
/* ============================================================ */
create index cod_usuario on cmr_contenido_usuario (cod_usuario)
go
...
/*   Index: cod_grupo                                           */
/* ============================================================ */
create index cod_grupo on cmr_contenido_grupos (cod_grupo)
go
...
/*   Index: cod_usuario                                         */
/* ============================================================ */
create index cod_usuario on sys_archivos_usuarios (cod_usuario)
go
...
/*   Index: cod_usuario                                         */
/* ============================================================ */
create index cod_usuario on sys_comentario_usuario (cod_usuario)
go
...
alter table cms_nodos
    add constraint FK_CMS_NODO_REF_5314_SYS_USUA foreign key  (cod_usuario)
...
alter table cms_contenidos
    add constraint FK_CMS_CONT_REF_5318_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go
...
alter table app_ranking
    add constraint FK_APP_RANK_REF_10014_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go

alter table syr_grupo_usuarios
    add constraint FK_SYR_GRUP_REF_5232_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go

alter table syr_grupo_usuarios
    add constraint FK_SYR_GRUP_REF_5239_SYS_GRUP foreign key  (cod_grupo)
       references sys_grupos (cod_grupo)
go

alter table syr_perfiles_usuarios
    add constraint FK_SYR_PERF_REF_5220_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go

alter table syr_perfiles_usuarios
    add constraint FK_SYR_PERF_REF_5244_SYS_PERF foreign key  (cod_perfil)
...
alter table syr_info_usuarios
    add constraint FK_SYR_INFO_REF_5199_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go

alter table cmr_nodos_usuarios
    add constraint FK_CMR_NODO_REF_5293_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go
...
alter table cmr_nodos_grupos
    add constraint FK_CMR_NODO_REF_5285_SYS_GRUP foreign key  (cod_grupo)
       references sys_grupos (cod_grupo)
go
...
alter table cmr_contenido_usuario
    add constraint FK_CMR_CONT_REF_5277_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go
...
alter table cmr_contenido_grupos
    add constraint FK_CMR_CONT_REF_5281_SYS_GRUP foreign key  (cod_grupo)
       references sys_grupos (cod_grupo)
go

alter table sys_archivos_usuarios
    add constraint FK_SYS_ARCH_REF_5207_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go

alter table sys_relacion_usuarios
    add constraint FK_SYS_RELA_REF_5211_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go
...
alter table sys_comentario_usuario
    add constraint FK_SYS_COME_REF_5203_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go
...
alter table sys_seguir_usuarios
    add constraint FK_SYS_SEGU_REF_5877_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go

alter table sys_emailtouser
    add constraint FK_SYS_EMAI_REF_7020_SYS_USUA foreign key  (cod_usuario)
       references sys_usuario (cod_usuario)
go
