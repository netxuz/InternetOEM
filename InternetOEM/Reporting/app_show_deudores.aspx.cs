...
{
  public partial class app_show_deudores : System.Web.UI.Page
  {
    ...
    protected void rdGridDeudores_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
    {
      ...
      if (oConn.Open())
      {
        ...
        DataTable dtDeudores = oDeudores.Get();
    ...
    protected void rdGridDeudores_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
      if (e.CommandName == "Select") {
        hdd_coddeudor.Value = e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["lngCodDeudor"].ToString();
        hdd_razonsocial.Value = e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["RazonSocial"].ToString();
