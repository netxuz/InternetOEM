...
{
  public partial class app_historico_pago_find : System.Web.UI.Page
  {
    ...
    protected void rdGridHistoricoPago_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
      rdGridHistoricoPago.DataSource = getDatatble();
    }

    protected void rdGridHistoricoPago_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
      if (e.CommandName == RadGrid.ExportToExcelCommandName)
      {
        ...
        wb.Worksheets.Add(dt, "historicopago");
    ...
    public DataTable getDatatble()
    {
      ...
      if (oConn.Open())
      {
        ...
        oHistoricoPago.DtFchFin = DateTime.Parse(RadDatePicker2.SelectedDate.ToString()).ToString("yyyyMMdd");
        dt = oHistoricoPago.Get();
        //Response.Write(oHistoricoPago.Query);
