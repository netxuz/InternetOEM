  ...
  public partial class app_rep_lit_por_motivo_find : System.Web.UI.Page
  {
    ...
    public DataTable getDatatble()
    {
      ...
      if (oConn.Open())
      {
        ...
        oReporteLitigiosMotivos.CodNkey = ((!string.IsNullOrEmpty(cmbCliente.SelectedValue) ? cmbCliente.SelectedValue : hdd_arrNkeyCliente.Value));
        oReporteLitigiosMotivos.NcodHolding = cmbHolding.SelectedValue;
