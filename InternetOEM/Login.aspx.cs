        ...
        if (dUsuario != null)
          if (dUsuario != null)
            if (dUsuario.Rows.Count > 0)
            {
              ...
              oIsUsuario.CodUsuario = dUsuario.Rows[0]["cod_user"].ToString();
              oIsUsuario.Tipo = dUsuario.Rows[0]["cod_tipo"].ToString();
              oIsUsuario.Nombres = (dUsuario.Rows[0]["nom_user"].ToString() + " " + dUsuario.Rows[0]["ape_user"].ToString()).Trim();
              oIsUsuario.Email = dUsuario.Rows[0]["est_user"].ToString();
              ...
              oPerfilesUsuarios.CodUsuario = dUsuario.Rows[0]["cod_user"].ToString();
