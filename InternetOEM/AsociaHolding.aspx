<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsociaHolding.aspx.cs" Inherits="ICommunity.AsociaHolding" %>
  ...
  <form id="form1" runat="server">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <button type="button" id="btnSeleccionar" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Asociar Holding a Usuario</button>
      </div>
      <div class="row">&nbsp;</div>
      <div class="row">
        <h4>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" OnLoad="UpdatePanel1_Load">
          <ContentTemplate>
            ...
            <telerik:RadGrid ID="rdClienteUsuario" runat="server" ShowStatusBar="True" AutoGenerateColumns="false" AllowSorting="True" PageSize="15" AllowPaging="True" GridLines="None" Skin="Sitefinity"
              ...
              <MasterTableView DataKeyNames="ncod_holding" AutoGenerateColumns="false" ShowHeader="true"
                ...
                <Columns>
                  ...
                  <telerik:GridBoundColumn UniqueName="ncod_holding" HeaderText="ncodholding" DataField="ncod_holding" AllowSorting="true">
                    <HeaderStyle Font-Size="Smaller" Width="100px" HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                  </telerik:GridBoundColumn>

                  <telerik:GridBoundColumn UniqueName="sNombre" HeaderText="Holding" DataField="snombre" AllowSorting="true">
                  ...
                  <ContentTemplate>
                    ...
                    <div class="row">
                      <telerik:RadGrid ID="rdCliente" runat="server" ShowStatusBar="True" AutoGenerateColumns="false" OnNeedDataSource="rdCliente_NeedDataSource" OnItemCommand="rdCliente_ItemCommand" OnItemDataBound="rdCliente_ItemDataBound"
                        ...
                        <MasterTableView DataKeyNames="ncodholding" AutoGenerateColumns="false" ShowHeader="true"
                          TableLayout="Fixed" ShowHeadersWhenNoRecords="true" CommandItemDisplay="Top">
                          <CommandItemSettings ShowExportToExcelButton="false" ShowRefreshButton="false" ShowAddNewRecordButton="false" />
                          <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="ncodholding" HeaderText="ncodholding" DataField="ncodholding" AllowSorting="true">
                              <HeaderStyle Font-Size="Smaller" Width="100px" HorizontalAlign="Center" />
                              <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn UniqueName="sNombre" HeaderText="Holding" DataField="Holding" AllowSorting="true">
                              <HeaderStyle Font-Size="Smaller" HorizontalAlign="Center" />
                              <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
