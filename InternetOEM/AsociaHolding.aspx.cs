...
{
  public partial class AsociaHolding : System.Web.UI.Page
  {
    Web oWeb = new Web();
    ...
    protected void rdClienteUsuario_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
      ...
      if (oConn.Open())
      {
        SysHoldingCliente oHoldingCliente = new SysHoldingCliente(ref oConn);
        oHoldingCliente.CodUsuario = CodUsuario.Value;
        rdClienteUsuario.DataSource = oHoldingCliente.Get();
    ...
    protected void rdClienteUsuario_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
      ...
      {
        case "cmdDelete":
          string pCodHolding = e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["ncod_holding"].ToString();
          DBConn oConn = new DBConn();
          if (oConn.Open())
          {
            SysHoldingCliente oHoldingCliente = new SysHoldingCliente(ref oConn);
            oHoldingCliente.CodUsuario = CodUsuario.Value;
            oHoldingCliente.CodHolding = pCodHolding;
            oHoldingCliente.Accion = "ELIMINAR";
            oHoldingCliente.Put();
    ...
    protected void rdCliente_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
      ...
      if (oConn.Open())
      {
        SysHoldingCliente oHoldingCliente = new SysHoldingCliente(ref oConn);
        oHoldingCliente.CodUsuario = CodUsuario.Value;
        oHoldingCliente.sNombre = txtBuscarCliente.Text;
        rdCliente.DataSource = oHoldingCliente.GetHoldingNotInUsuario();
    ...
    protected void rdCliente_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
      ...
      {
        case "cmdAgregar":
          string pCodHolding = e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["ncodholding"].ToString();
          DBConn oConn = new DBConn();
          if (oConn.Open())
          {
            SysHoldingCliente oHoldingCliente = new SysHoldingCliente(ref oConn);
